...
#         self.path=path
#
#     def __make_frequency_dict(self,other):
#         freq_dict={}
#         for char in text:
...
#         for key in freq_dict:
#             frequency=freq_dict[key]
#             binary_tree_node=BinaryTreeCode(key,frequency)
#             heapq.heappush(self.__heap,binary_tree_node)
#
#     def __buildTree(self):
#         while (len(self.__heap)>1):
#             binary_tree_node1=heapq.heappop(self.__heap)
#             binary_tree_node2=heap.heappop(self.__heap)
#             freq_sum=binary_tree_node1.freq+binary_tree_node2.freq
#             newNode=BinaryTreeCode(None,freq_sum)
...
#             return
#         self.__buildCodesHelper(self,root,curr_bits+"0")
#         self.__buildCodesHelper(self,root,curr_bits+"1")
#
#     def __buildCodes(self):
#         root=heappq.heappop(self.__heap)
...
#         return encoded_text
#     def _getBytesArrays(self,padded_encoded_text):
#         array=[]
...
#             return output_path
#
# path= 'C:\Users\milin\PycharmProjects\pythonProject\millu2.txt'
...
path = r'C:\Users\milin\Downloads\sample2.txt'
h = HuffmanCoding(path)
output_path = h.compress()
